...
Sccenario: sort challenges by start date
  When I follow "Start Date"
  Then I should see "Computer Vision Challenge" before "HIV Challenge"

Sccenario: sort challenges by end date
  When I follow "End Date" 
  Then I should see "Computer Vision Challenge" before "HIV Challenge"

Sccenario: sort challenges by create date
  When I follow "Create Date"
  Then I should see "Computer Vision Challenge" before "HIV Challenge"

Sccenario: sort challenges by title
